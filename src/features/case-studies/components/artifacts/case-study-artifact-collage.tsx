import CaseStudyArtifactImage from './case-study-artifact-image';
...
export const ImageCollageContainer = ({
  images,
  padding = 20,
  height = 420,
  variant = 'side',
