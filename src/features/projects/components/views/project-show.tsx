...
import { loadCaseStudiesByProject } from '@/features/case-studies/lib';
import { type RelatedCaseStudyCard } from '@/features/case-studies/components';
import {
  getProjectShowSlugs,
  loadProjectBySlug,
} from '../../lib/projects-loader';
import { ProjectCta, RelatedCaseStudies } from '../shared/project-cta';
import { ProjectMeta } from '../shared/project-meta';
import { ProjectShowContent } from '../layouts/project-show-content';
  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <ProjectShowContent
        ...
        linkItems={projectData.linkItems}
        mdx={projectData.mdx}
      />
