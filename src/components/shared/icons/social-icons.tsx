...
export const XIcon = ({ className, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M9.519 6.774 15.46 0H14.05L8.89 5.882 4.77 0H0l6.23 8.896L0 16h1.41l5.445-6.207L11.23 16H16L9.519 6.774Zm-1.95 2.223-.632-.885L1.91 1.08h2.17l4.056 5.68.632.885 5.272 7.382h-2.17L7.57 8.997Z" />
  </svg>
);
